...
enum RuntimeSupportMode: String, Sendable, Codable {
    ...
    case bundledFramework = "Bundled runtime"
    case runtimePack = "Runtime pack"
    case remoteRunner = "Remote runner"

    var symbol: String {
        switch self {
        case .builtIn: return "checkmark.seal.fill"
        case .bundledFramework: return "shippingbox.fill"
        case .runtimePack: return "cube.transparent"
        case .remoteRunner: return "cloud"
        }
    }
}
...
enum RuntimeKind: String, CaseIterable, Identifiable, Sendable, Codable {
    ...
    static func apiValue(_ raw: String) -> RuntimeKind? {
        ...
        default: return RuntimeKind.allCases.first { $0.rawValue.lowercased() == raw.lowercased() }
        }
    }
    ...
    var supportDescription: String {
        switch supportMode {
        case .builtIn:
            return "Small JavaScript snippets can run in the editor, but project servers still run on your backend."
        case .bundledFramework:
            return "Legacy local runtime support. Nexora Host project execution is remote-first."
        case .runtimePack:
            return "Legacy runtime-pack support. Nexora Host project execution is remote-first."
        case .remoteRunner:
            return "Runs on your Debian backend or an isolated worker, not on the iPhone."
        }
    }
    ...
    var starterSource: String {
        ...
        case .node: return "console.log('Hello from Nexora Host Node.js');\n"
        case .bun: return "console.log('Hello from Nexora Host Bun');\n"
        ...
        case .csharp: return "System.Console.WriteLine(\"Hello from Nexora Host\");\n"
        case .java: return "public class Main { public static void main(String[] args) { System.out.println(\"Hello from Nexora Host\"); } }\n"
        case .dotnet: return "System.Console.WriteLine(\"Hello from Nexora Host\");\n"
        case .docker: return "services:\n  app:\n    image: node:22-alpine\n    working_dir: /app\n    volumes:\n      - .:/app\n    command: node index.js\n"
