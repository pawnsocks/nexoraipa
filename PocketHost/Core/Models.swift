...
enum RuntimeKind: String, CaseIterable, Identifiable, Sendable, Codable {
    ...
    var supportMode: RuntimeSupportMode {
        switch self {
        case .javascript: return .builtIn
        case .python, .lua: return .interpreter
        case .typescript: return .experimental
    ...
    var supportDescription: String {
        ...
        case .typescript:
            return "Editing is supported. A local TypeScript transpiler is not bundled yet."
        case .node:
            return "Full desktop Node.js is not available on normal iOS."
        case .bun:
    ...
    var starterSource: String {
        ...
        case .node: return "console.log('Node.js is not a local Nexora runtime on iOS.');\n"
